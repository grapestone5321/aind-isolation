...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        try:
            ...
            pass  # Return the current state of the game including the evaluation.
    ...
    def min_value(self, game, depth, alpha, beta):
        ...
        value = float('inf')
        for move in moves:
            value = min(value, self.max_value(game=game.forecast_move(move), depth=depth - 1,
    ...
    def max_value(self, game, depth, alpha, beta):
        ...
        value = float('-inf')
        for move in moves:
            value = max(value, self.min_value(game=game.forecast_move(move), depth=depth - 1,
                                              alpha=alpha, beta=beta))
            if value >= beta:
                return value
            alpha = max(alpha, value)
